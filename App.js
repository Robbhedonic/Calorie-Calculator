    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
      ...
      >
        ...
        >
          ...
          <View style={{ flex: 1, minWidth: 0 }}>
            ...
            <View style={{ flexDirection: 'row', gap: 8, marginBottom: 16 }}>
              <TouchableOpacity
                style={{
                  flex: 1,
                  backgroundColor: gender === 'male' ? '#db7c36' : '#fff',
                  borderRadius: 8,
                  padding: 12,
                  alignItems: 'center',
                  borderWidth: 1,
              ...
              >
                <Text style={{ color: gender === 'male' ? '#fff' : '#db7c36', fontWeight: 'bold' }}>
                  Male
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={{
                  flex: 1,
                  backgroundColor: gender === 'female' ? '#db7c36' : '#fff',
                  borderRadius: 8,
                  padding: 12,
                  alignItems: 'center',
                  borderWidth: 1,
              ...
              >
                <Text
                  style={{ color: gender === 'female' ? '#fff' : '#db7c36', fontWeight: 'bold' }}
                >
                  Female
                </Text>
              </TouchableOpacity>
            ...
            <TextInput
              style={[inputStyle, { maxWidth: 120, alignSelf: 'flex-start', width: '100%' }]}
              placeholder="e.g. 28"
            ...
            <View style={{ gap: 8, marginBottom: 16 }}>
              <TouchableOpacity
                style={[goalBtn, goal === 'maintain' && goalBtnActive]}
                onPress={() => setGoal('maintain')}
              >
                <Text style={[goalText, goal === 'maintain' && goalTextActive]}>
                  Maintain weight
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[goalBtn, goal === 'lose' && goalBtnActive]}
                onPress={() => setGoal('lose')}
              >
                <Text style={[goalText, goal === 'lose' && goalTextActive]}>Lose fat (-15%)</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[goalBtn, goal === 'gain' && goalBtnActive]}
                onPress={() => setGoal('gain')}
              >
                <Text style={[goalText, goal === 'gain' && goalTextActive]}>
                  Build muscle (+10%)
                </Text>
              </TouchableOpacity>
            </View>
            <TouchableOpacity
              style={[calcBtnStyle, { maxWidth: 340, alignSelf: 'center', width: '100%' }]}
              onPress={calculate}
            >
          ...
          <View style={{ flex: 1, minWidth: 0 }}>
            ...
            <View style={{ gap: 8, marginBottom: 8 }}>
              <TouchableOpacity
                style={[activityBtn, activity === 1 && activityBtnActive]}
                onPress={() => setActivity(1)}
              >
                <Text style={[activityText, activity === 1 && activityTextActive]}>
                  Sedentary (little or no exercise)
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[activityBtn, activity === 2 && activityBtnActive]}
                onPress={() => setActivity(2)}
              >
                <Text style={[activityText, activity === 2 && activityTextActive]}>
                  Light (1-3 days/week)
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[activityBtn, activity === 3 && activityBtnActive]}
                onPress={() => setActivity(3)}
              >
                <Text style={[activityText, activity === 3 && activityTextActive]}>
                  Moderate (3-5 days/week)
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[activityBtn, activity === 4 && activityBtnActive]}
                onPress={() => setActivity(4)}
              >
                <Text style={[activityText, activity === 4 && activityTextActive]}>
                  High (6-7 days/week)
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[activityBtn, activity === 5 && activityBtnActive]}
                onPress={() => setActivity(5)}
              >
                <Text style={[activityText, activity === 5 && activityTextActive]}>
                  Very high (physical job + training)
                </Text>
              </TouchableOpacity>
            </View>
          </View>
        ...
        <View style={{ minHeight: 60, maxWidth: 400, alignSelf: 'center', width: '100%' }}>
          {result ? (
            <View>
              <Text style={{ color: '#222', fontSize: 18, marginBottom: 8 }}>
                Your result:{' '}
                <Text style={{ fontWeight: 'bold' }}>{Math.round(result.target)} kcal/day</Text>
              </Text>
              ...
              {(() => {
                ...
                return (
                  <View>
                    ...
                    >
                      <Text style={{ color: '#db7c36', fontWeight: 'bold', marginBottom: 4 }}>
                        Recommended daily macros:
                      </Text>
                      <Text style={{ color: '#222', marginBottom: 2 }}>
                        Carbohydrates: <Text style={{ fontWeight: 'bold' }}>{carbs} g</Text>
                      </Text>
                      <Text style={{ color: '#222', marginBottom: 2 }}>
                        Protein: <Text style={{ fontWeight: 'bold' }}>{protein} g</Text>
                      </Text>
                      <Text style={{ color: '#222' }}>
                        Fat: <Text style={{ fontWeight: 'bold' }}>{fat} g</Text>
                      </Text>
                    </View>
                    <View
                      style={{
                    ...
                    >
                      ...
                      {meals.map((meal, idx) => {
                        ...
                        return (
                          <View
                            key={meal.name}
                            style={{ marginBottom: idx < meals.length - 1 ? 8 : 0 }}
                          >
